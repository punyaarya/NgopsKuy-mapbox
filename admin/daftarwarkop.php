                                    ...
                                    <tbody>
                                        ...
                                        while ($warkop = $hasil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td><?= $warkop['lat'] ?></td>
                                                <td>
                                                    <a href="aksi_delete.php?id=<?= $warkop['id'] ?>"><i class="fas fa-trash fa-xs text-white p-2 bg-danger rounded"></i></a>
                                                    <a href="updatewarkop.php?id=<?= $warkop['id'] ?>"><i class="fas fa-edit fa-xs text-white p-2 bg-warning rounded"></i></a>
                                                    <a href="detail.php?id=<?= $warkop['id'] ?>"><i class="fas fa-info-circle fa-xs text-white p-2 bg-primary rounded"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
