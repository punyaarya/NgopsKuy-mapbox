...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Ketersediaan Warkop</title>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div>Manage Ketersediaan Warkop
                                        <div class="page-title-subheading">
                                        </div>
                                    </div>
                                </div>
                                <div class="page-title-actions">
                                    <a href="insertwarkop.php" class="btn btn-primary">Insert</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        while ($warkop = $hasil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if ($warkop['curr_cap'] > 0 && $warkop['curr_cap'] < $warkop['max_cap'] ) { ?>
                                                        <a href="aksi_kurang.php?id=<?= $warkop['id'] ?>&curr_cap=<?= $warkop['curr_cap'] ?>"><i class="fas fa-minus fa-xs text-white p-2 bg-danger rounded"></i></a>
                                                        <a href="aksi_tambah.php?id=<?= $warkop['id'] ?>&curr_cap=<?= $warkop['curr_cap'] ?>"><i class="fas fa-plus fa-xs text-white p-2 bg-primary rounded"></i></a>
                                                    <?php } else if  ($warkop['curr_cap'] == 0){ ?>
                                                        <a href="aksi_tambah.php?id=<?= $warkop['id'] ?>&curr_cap=<?= $warkop['curr_cap'] ?>"><i class="fas fa-plus fa-xs text-white p-2 bg-primary rounded"></i></a>
                                                    <?php }
                                                    if ($warkop['curr_cap'] == $warkop['max_cap'] ) { ?>
                                                        <a href="aksi_kurang.php?id=<?= $warkop['id'] ?>&curr_cap=<?= $warkop['curr_cap'] ?>"><i class="fas fa-minus fa-xs text-white p-2 bg-danger rounded"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
