                ...
                <div class="animated slideInLeft">
                    <div class="app-main__inner">
                        ...
                        <div class="main-card mb-3 card">
                            ...
                            Praktikum Sistem Informasi Geografis Kelas G
                            </p>
                            <p class="h5 text-center mb-3">
                            Teknik Informatika UIN Malang
                            </p>
                                <p class="h5 text-center text-justify mb-3 ">
                                    
                                    </br>
                                    Kelompok 4:</br>
                                    Mustafa Kamal Rabbani (17650057)</br>
                                    Arya Abimanyu (17650059)</br>
                                    Mokhamad Alrizaldo Rajabiantoro (17650070)</br>
                                    Taufiqurrahman Idrus (17650088)</br>
                                </p>
                            </div>
                        </div>
                    </div>
